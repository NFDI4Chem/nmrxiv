...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_ENV', 'local').'/database',
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'nmrxiv-data-dump-',
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('MAIL_FROM_ADDRESS', 'info.nmrxiv@uni-jena.de'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'info.nmrxiv@uni-jena.de'),
                'name' => env('MAIL_FROM_NAME', 'nmrXiv-backup'),
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('BACKUP_MAX_STORAGE_MB', 300000),
        ],
    ],
