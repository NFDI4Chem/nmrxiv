...
return [
     ...
     * if so the request will be stamped as spam. The support bubble is the
     * only form in this app using honeypot and it always renders these
     * fields, so this also blocks bots that post directly without ever
     * rendering the form (and therefore never see the honeypot/valid_from
     * fields at all).
     */
