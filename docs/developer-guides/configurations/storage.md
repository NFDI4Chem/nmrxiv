...
Files in [nmrxiv](https://nmrxiv.org) are stored as [objects](https://en.wikipedia.org/wiki/Object_storage) in the S3-compatible storage service provided by the FSU URZ data center. The application itself runs on virtual machines hosted by FSU URZ. This provides the following benefits.
