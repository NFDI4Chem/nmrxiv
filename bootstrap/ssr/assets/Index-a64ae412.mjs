...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderList, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
...
const TeamProjects = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  TeamProjects as default
};
