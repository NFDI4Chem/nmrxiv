...
import { resolveComponent, withCtx, createTextVNode, createSlots, createVNode, openBlock, createBlock, Fragment, toDisplayString, withKeys, createCommentVNode, useSSRContext } from "vue";
...
const ProjectDelete = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  ProjectDelete as default
};
