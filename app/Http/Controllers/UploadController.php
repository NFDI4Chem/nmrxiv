...
class UploadController extends Controller
{
    ...
    public function publish(Request $request, Draft $draft)
    {
        ...
        return Inertia::render('Publish', [
            'draft' => $draft,
            'project' => Project::with(['studies.datasets', 'studies.sample.molecules', 'studies.sample.mixtureComposition.components.molecule', 'owner', 'citations', 'authors', 'tags', 'license'])->where('draft_id', $draft->id)->first(),
