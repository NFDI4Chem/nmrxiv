<template>
    <app-layout title="Curation">
        ...
        <div class="p-10">
            <div
                class="border divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0"
            >
                <Link :href="'/admin/snapshots'">
                    <div
                        class="rounded-tl-lg rounded-tr-lg sm:rounded-tr-none group relative bg-white p-6"
                    >
                        <div>
                            <span
                            ...
                            >
                                <a class="focus:outline-none">
                                    ...
                                    <span
                                        ...
                                        aria-hidden="true"
                                    ></span>
                                    Import spectra snapshots
                                </a>
                            </h3>
                            <p class="mt-2 text-sm text-gray-500">
                                Imports missing spectra snapshots for spectra
                                card previews
                            </p>
                        </div>
                        <span
                ...
                >
                    <div>
                        <span
                            class="inline-flex rounded-lg p-3 bg-rose-50 text-rose-700 ring-4 ring-white"
                        >
                            <svg
                                class="h-6 w-6"
                                fill="none"
