  ...
  <div class="bg-white">
    <main>
      ...
      <div class="bg-gray-50 border-t border-b border-gray-100">
        <div class="max-w-7xl mx-auto content-center py-16 px-4 sm:px-6 lg:px-8">
          <p
              ...
              <div>
                ...
                <div class="mt-6">
                  ...
                  <p class="mt-4 text-lg text-gray-500">
                    nmrXiv offers a ready-to-use NMR data management platform to host your
                    raw instrument data and processed files for free and provides you with
                    tools and services to analyse data. Additionally, get community
                    support for any of your NMR spectra-related queries or provide one
                    yourself.
                  </p>
                  <div class="mt-6">
                    <Link
              ...
              <div>
                ...
                <div class="mt-6">
                  ...
                  <p class="mt-4 text-lg text-gray-500">
                    ...
                    its rich data/metadata descriptions to develop advanced
                    toolsets/software.
                  </p>
                  <div class="mt-6">
                    <a
            ...
            >
              <div>
                ...
                <div class="mt-6">
                  ...
                  <p class="mt-4 text-lg text-gray-500">
                    Data deposited in nmrXiv requires original machine output files or
                    processed raw data. With this data, researchers can annotate the
                    missing assignments in the spectra, reanalyse previous work and offer
                    additional help there by sharing their knowledge and expertise.
                  </p>
                  <div class="mt-6">
                    <Link
                      href="#"
