...
-->
    <div class="flex flex-col h-screen justify-between">
        ...
        <main>
            <!-- Hero section -->
            <div
                class="pt-8 mb-auto overflow-hidden sm:pt-12 lg:relative lg:py-48"
            >
                <div
                        ...
                        <div class="mt-10">
                            <div class="mt-6 sm:max-w-xl">
                                ...
                                <p class="mt-6 text-xl text-gray-500">
                                    ...
                                    natural product (NP) researchers by enabling
                                    storage, management, sharing and analysis of
                                    NMR data.
                                </p>
                            </div>
                            <div class="mt-10">
                                <a
                                    href="/login"
                                    class="rounded-md border border-transparent px-5 py-3 bg-teal-500 text-base font-medium text-white shadow hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10"
                                >
                                    Login
                                </a>
                                <a
                                    href="/register"
                                    class="rounded-md border border-transparent px-5 ml-2 py-3 bg-white-500 text-base font-medium text-dark shadow hover:bg-white-600 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:px-10"
                                >
                                    Register
                                </a>
                            </div>
                            <div v-if= "$page.props.environment.toLowerCase() != 'production' " class="pt-10">
                                <div
                                    class="border border-teal-500 rounded px-4 py-3 mt-3 max-w-2xl text-sm text-gray-700 font-bold"
                                >
                                    <p>
                                        Warning: This site is for demonstration
                                        purpose only. You can test most of the
                                        nmrXiv features but DO NOT use the
                                        current site for your work. All the data
