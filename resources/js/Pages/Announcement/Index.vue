<template>
  <app-layout title="Announcements and Notifications">
    ...
    <div class="py-12 px-10">
      <span v-if="announcements.length > 0">
        ...
        <div>
          <div class="bg-white rounded-md shadow overflow-x-auto">
                ...
                <tr v-for="announcement in announcements" :key="announcement.id">
                  <td colspan="3" class="py-4">
                    <div class="ml-4">
                      ...
                      <p class="mt-1 mb-3 text-sm text-blue-gray-900 break-normal">
                        {{ announcement.message }}
                      </p>
                      <label class="block text-sm mt-2 font-medium text-gray-500">
                        Created by
                      </label>
                      <p class="mt-1 text-md text-blue-gray-900">
                        {{ announcement.created_by }}
                      </p>
                      <label class="block text-sm mt-2 font-medium text-gray-500">
                        From
                      </label>
                      <p class="mt-1 text-sm text-blue-gray-900">
                  ...
                  <td class="px-5 py-4 text-center whitespace-nowrap">
                    <span
                      v-if="
                        announcement.status == 'active' || announcement.status == 'Active'
                      "
                  ...
                  >
                    <button
                      ...
                      @click="openAnnouncementEditDialog(announcement)"
                    >
                      <icon name="edit" />
                    </button>
                    <button
                      ...
                      @click="confirmAnnouncementDeletion(announcement.id)"
                    >
                      <icon name="delete" />
                    </button>
                  </td>
            ...
            <jet-dialog-modal :show="confirmingAnnouncementDeletion" @close="closeModal">
      ...
      <announcement-create ref="announcementCreateElement"></announcement-create>
      <announcement-edit ref="announcementEditElement"></announcement-edit>
    </div>
  </app-layout>
</template>
...
export default {
  ...
  methods: {
    ...
    openAnnouncementEditDialog(announcement) {
      this.announcementEditElement.toggleEditAnnouncementDialog(announcement);
    },
