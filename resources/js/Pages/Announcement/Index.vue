<template>
    <app-layout title="Announcements and Notifications">
        ...
        <div class="py-12 px-10">
            ...
            <span v-else>
                <jet-secondary-button
                    class="block w-fit center border-2 border-gray-300 border-dashed rounded-lg p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    @click="openAnnouncementCreateDialog()"
                >
                    <BellAlertIcon
                        class="mx-auto h-40 w-12 text-gray-400"
                        aria-hidden="true"
                    />
                    <span class="mx-auto text-sm font-medium text-gray-900">
