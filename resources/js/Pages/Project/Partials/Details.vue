                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <input
                                                                ...
                                                                "
                                                                type="text"
                                                                class="rounded-l-md focus:ring-teal-500 focus:border-teal-500 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300"
                                                            />
                                                        </div>
                                                        <button
                                                            @click="
                                                            ...
                                                            "
                                                            type="button"
                                                            class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-teal-500 focus:border-teal-500"
                                                        >
                                                            <span
                                                                ><ClipboardCopyIcon
                                                                    class="h-5 w-5"
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <input
                                                                    ...
                                                                    "
                                                                    type="checkbox"
                                                                    class="focus:ring-teal-500 h-4 w-4 text-teal-500 border-gray-300 rounded"
                                                                />
                                                            </div>
                                                            <div
                                                                class="ml-3 text-sm"
                                                        ...
                                                        <div v-if="linkAccess">
                                                            <div class="flex">
                                                                ...
                                                                <button
                                                                    ...
                                                                    "
                                                                    type="button"
                                                                    class="-ml-px relative inline-flex items-center space-x-2 px-2 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-teal-500 focus:border-teal-500"
                                                                >
                                                                    <span
                                                                        ><ClipboardCopyIcon
                                                                            class="h-5 w-5"
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <div
                                                                            class="inline-flex shadow-sm rounded-md divide-x divide-teal-500"
                                                                        >
                                                                            <div
                                                                                class="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-teal-500"
                                                                            >
                                                                                <div
                                                                                    class="relative inline-flex items-center bg-teal-500 py-2 pl-3 pr-4 border border-transparent rounded-l-md shadow-sm text-white"
                                                                                >
                                                                                    <CheckIcon
                                                                                        class="h-5 w-5"
                                                                                        aria-hidden="true"
                                                                                ...
                                                                                <ListboxButton
                                                                                    class="relative inline-flex items-center bg-teal-500 p-2 rounded-l-none rounded-r-md text-sm font-medium text-white hover:bg-teal-500 focus:outline-none focus:z-10 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-teal-500"
                                                                                >
                                                                                    <span
                                                                                        class="sr-only"
                                                                                        >Change
