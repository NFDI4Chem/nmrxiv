            ...
            <div class="">
              ...
              >
                <StarIcon
                  @click="toogleStarred"
                  :class="[
                    project.starred ? 'text-yellow-400' : 'text-gray-200',
              ...
              <div class="inline-flex items-center mt-3">
                ...
                <a
                  ...
                  <span v-else class="inline-flex ml-7 items-center">
                    <svg
    ...
    <div class="p-12">
      <div>
        ...
        <div class="mb-4">
          ...
          <dd class="mt-1 text-md text-gray-900 space-y-5">
            <p>
              <span class="mr-2" v-for="tag in project.tags" :key="tag.id">
                <span
        ...
        <study-index :editable="editable" :project="project" :studies="studies" />
      </div>
    </div>
  </app-layout>
</template>
...
export default {
  ...
  methods: {
    toogleStarred() {
      axios.post(route("projects.toggle-starred", project)).then((res) => {});
    },
    toggleDetails() {
