                            ...
                            <div class="mx-auto max-w-6xl pb-32 px-8">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            In recent decades, attempts have
                                            been made to create NMR databases
                                            from literature, but they don't
                                            fully meet the needs of all chemical
                                            communities. nmrXiv is the first
                                            open archive to preserve NMR data in
                                            its original instrument format while
                                            ...
                                            user-friendly platform for chemists.
                                            Our public platform ensures that NMR
                                            data is freely accessible, promoting
                                            ...
                                            platform includes quality control
                                            tools to verify the integrity and
                                            accuracy of NMR data before
                                            publication. With advanced search
                                            and retrieval features powered by
                                            comprehensive metadata, nmrxiv
                                            allows researchers to efficiently
                                            locate and utilize specific
                                            datasets, fostering greater
