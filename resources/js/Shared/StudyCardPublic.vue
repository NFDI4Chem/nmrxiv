...
<template>
    ...
    >
        ...
        <Link :href="study.public_url" class="block">
            ...
            >
                ...
                >
                    ...
                    <div v-else class="relative h-full">
                        ...
                        >
                            <div
                                class="flex space-x-2 bg-black/30 backdrop-blur-sm rounded-full px-3 py-2"
                            >
                ...
                <div
                    v-else-if="
                        ...
                        molecules[0].canonical_smiles.trim() !== ''
                    "
                ...
                >
                    <div
                        class="inline-flex items-center px-2 py-1 sm:px-2.5 sm:py-1 rounded-full text-xs font-medium bg-black/30 text-white backdrop-blur-md"
                    >
                        ...
                        <span class="sm:hidden"
                            >{{ cleanIdentifier.substring(0, 6) }}...</span
                        >
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white">
                <div
                    class="p-3 sm:p-4 border-t border-gray-200 cursor-pointer"
                    style="height: 213px"
                >
                    <!-- Creation date -->
                    ...
                    <p
                        class="text-base sm:text-lg font-black text-gray-900 line-clamp-2 overflow-hidden break-all"
                    >
                        {{ study.name }}
                    </p>
                    ...
                    <p
                        class="text-xs sm:text-sm text-gray-500 line-clamp-2 break-all sm:line-clamp-2"
                    >
                        {{ study.description }}
                    </p>
                    ...
                    <div
                        v-if="hasExperimentTypes"
                        class="mt-1 h-12 sm:h-14 overflow-hidden"
                    >
                        ...
                        <span
                            v-if="
                                ...
                                study.experiment_types.length > 3
                            "
                            class="mt-1 inline-flex items-center rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"
                        >
    ...
    computed: {
        ...
        molecules() {
            ...
            if (
                ...
                Array.isArray(this.study.sample.molecules)
            ) {
        ...
        hasExperimentTypes() {
            return (
                this.study.experiment_types &&
                this.study.experiment_types.length > 0 &&
                this.study.experiment_types.some(
                    (type) => type && type.trim() !== ""
                )
            );
        },
