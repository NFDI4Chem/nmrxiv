            ...
            <Dialog as="div" class="relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div v-if="status == 'queued' || status == 'processing' || status == 'complete'">
                                <div class="py-16">
                                        ...
                                        <div class="ml-2">
                                            <div class="flex items-top">
                                                ...
                                                <div class="ml-2 text-sm">
                                                    ...
                                                    the underlying studies and
                                                    datasets will also be made
                                        ...
                                        <div class="ml-2">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2 text-sm">
                                                    ...
                                                    permissions to distribute
                                                    the datasets (and meta-data)
                            ...
                            <div>
                                <div class="px-8 pb-8 pt-0">
                                    <button
                                        type="button"
                                        :class="[!form.terms || !form.conditions ? 'bg-gray-200 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700' , 'inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:w-auto sm:text-sm']"
                                        @click="publish"
                                        :disabled = "!form.terms && !form.conditions"
                                    >
                                        Publish
                                    </button>
                                    <button
                                ...
                                <div v-if="errors">
                                    <div class="rounded-md bg-red-50 p-4 mx-4 mb-4">
                                        <div class="flex">
                                            ...
                                            <div class="ml-3">
                                            <h3 class="text-sm font-medium text-red-800">Error publishing your project</h3>
                            ...
                            <div class="w-full">
                                ...
                                >
                                    ...
                                    <div>
                                        <p>
                                            Upon clicking publish, your project
                                            is submitted to our queue system for
                                            automatic processing. Once
                                            successfully processed, your data is
                                            assigned with stable identifiers,
                                            and DOIs are generated. You will
                                            receive an email with citation
                                            details and other helpful
                                            information to share your datasets.
                                        </p>
    ...
    methods: {
        ...
        publish(){
            if(this.form.conditions && this.form.terms){
                this.errors = null;
                axios.post(route('dashboard.project.publish', this.project.id), this.form)
                .catch( err => {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (this.status != "complete") {
                        ...
                        return this.$inertia.visit(this.route('dashboard.projects', [this.project.id]));
                    }
                });
        },
    },
