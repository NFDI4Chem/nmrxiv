            ...
            <div class="rounded-md bg-red-50 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3 flex-1">
                        <button
                            type="button"
                            class="flex w-full items-center justify-between text-left text-sm font-medium text-red-800 focus:outline-none"
                            :aria-expanded="!spectraErrorsCollapsed"
                            aria-controls="spectra-errors-list"
                            @click="
