<template>
    <div class="flex flex-col h-full">
        <!-- Title Section -->
        <div class="mb-6">
            <h2 class="text-3xl font-bold text-gray-900">Peak List Search</h2>
                    ...
                    <div class="mt-2 flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <p class="text-xs text-gray-500 mb-1">
                                <span class="font-semibold">Format:</span> Shift
                                or Shift;Intensity[Multiplicity]
                            </p>
                            <p class="text-xs text-gray-400">
                                Multiplicity: s (singlet), d (doublet), t
                    ...
                    <div class="mt-2 flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <p class="text-xs text-gray-500 mb-1">
                                ...
                                Standard ACS NMR data format
                            </p>
                            <p class="text-xs text-gray-400">
                                Paste NMR data from supporting information or
                                publications
                            </p>
                        </div>
                        <button
