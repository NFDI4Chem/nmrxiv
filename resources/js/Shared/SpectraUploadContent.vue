<template>
    <div class="flex flex-col h-full">
        ...
        <label
            ...
            :class="isDragging ? 'border-gray-900 bg-gray-50' : 'border-gray-300 bg-gray-50/50 hover:border-gray-400 hover:bg-gray-50'"
        ...
        >
            ...
            <span class="px-6 py-3 text-sm font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800 transition-colors inline-flex items-center pointer-events-none">
            ...
            <div v-if="uploadedFiles.length > 0" class="absolute top-4 right-4 px-3 py-1.5 bg-gray-900 text-white text-sm font-medium rounded-full">
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const addFiles = (files) => {
            const validExtensions = [".jdx", ".dx", ".jdf", ".fid", ".zip", ".nmrml", ".mnova"];
