<template>
  ...
  >
    ...
    <template #content>
      ...
      >
        ...
        >
            ...
            <div>
              ...
              <div v-if="authorsList.length>0" class="sm:col-span-9 mt-4">
                <checkboxrich
                  :items="authorsList"
      ...
      <div>
            <div class="ml-2 mt-2 overflow-y-scroll">
    ...
    <template #footer>
      <jet-secondary-button @click="onCancel"> Cancel </jet-secondary-button>

      <jet-button class="ml-2" @click="addAuthor"> Add </jet-button>
    </template>
  </jet-dialog-modal>
</template>
...
export default {
    ...
    methods: {
        ...
        onCancel() {
            ...
            this.addAuthorForm.clearErrors();
            this.addAuthorForm.reset();
            this.authorsList = [];
            this.manualAddAuthor = {};
