            ...
            <div v-if="!loading" class="max-h-screen">
                <div v-if="drafts.length > 0 && !currentDraft">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-md">
                        <ul
                            role="list"
                            class="-my-5 divide-y divide-gray-200 p-4"
                        >
                            <li
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <vue-tags-input
                                        ...
                                        :tags="draftTags"
                                        @tags-changed="
                                            (newTags) => (draftTags = newTags)
                                        "
                                    />
                                </div>
                            </div>
                            <small @click="annotate()"
                                >Draft ID: {{ currentDraft.name }}</small
                            >
                            <form id="submission-dropzone" class="py-2 mb-3">
                                <div
                                    id="submission-dropzone-message"
                                    class="text-center"
                                >
                                    <div
                                        type="button"
                    ...
                    <div v-if="currentStep.id == '03'">
                        ...
                        >
                            ...
                            <div>
                                <div>
                                    <h3
                                        class="text-lg leading-6 font-bold text-teal-900 align"
                                    >
                                ...
                                >
                                    <div class="sm:col-span-3">
                                        ...
                                        <jet-input-error :message="updateProjectForm.errors.name" class="mt-2" />
                                    </div>
                                    <div class="sm:col-span-6">
                                        ...
                                        <jet-input-error :message="updateProjectForm.errors.description" class="mt-2" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-6">
                                <div>
                                    ...
                                    >
                                        ...
                                        <!-- Release date -->
                                        <div v-if="this.updateProjectForm.is_public == 'false' || !this.updateProjectForm.is_public" class="sm:col-span-3">
                                            <div>
                                                <label
                                    ...
                                    >
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    readonly
                                                    v-if="this.updateProjectForm.is_public =='false' ||
                                                    !this.updateProjectForm.is_public"
                                                    v-model="
                                                        this.project.private_url
                                                    "
                                                    type="text"
                                                    autocomplete="given-name"
                                                    class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                            ...
                                            >
                                                ...
                                                studies and datasets can be
                                                shared with others using this
                                                URL.
                                            </p>
                                        </div>
                                    ...
                                    <!-- Download ptions -->
                                    <div
                                        class="mt-4 mb-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6"
                                    >
        ...
        <template v-if="!loading && currentDraft" #footer>
            <span v-if="currentStep.id == '01'">
                ...
                <jet-button
                    ...
                    :disabled="
                        createDatasetForm.processing || loading || loadingStep
                    "
                >
            ...
            <span v-if="currentStep.id == '03'">
                <jet-button @click="updateProject">
                    Save and Finish
                </jet-button>
            </span>
        </template>
...
export default {
    ...
    methods: {
            ...
            this.$nextTick(() => {
                ...
                let options = {
                    ...
                    dictDefaultMessage: document.querySelector(
                        "#submission-dropzone-message"
                    ).innerHTML,
                    done() {},
                    accept(file, done) {
                        const url =
                            "/dashboard/storage/signed-draft-storage-url";
        ...
        createDataset() {
           ...
           // this.createDatasetForm.team_id =
