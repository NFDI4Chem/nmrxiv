<template>
    ...
    >
        <template #title>
            ...
            >
                <div id="v-step-14" class="flex items-left justify-start pl-5 float-left">
                    <b>{{
                                ...
                                <div class="flex-1 flex md:overflow-hidden">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span class="float-right" @click="toggleAutoImport()">
                                                <PlayIcon v-if="!$page.props.autoimport" class="w-5 h-5"></PlayIcon>
                                                <PauseIcon v-else class="w-5 h-5"></PauseIcon>
                                            </span>
                                        </div>
                                        <div
                                            style="
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <span class="float-right border rounded-full px-2 py-1 mb-2" @click="autoGenerateDescription()">
                                                                            Auto generate
                                                                        </span>
                                                                    </label>
                                                                    <div
            ...
            this.selectedStudy.datasets.forEach(ds => {
                ...
                if(nmriuminfo){
                    ...
                    spectra.forEach(sp => {
                        ...
                        sampleTags.push(this.isString(sp.info.nucleus) ? sp.info.nucleus : sp.info.nucleus.join(" - "))
