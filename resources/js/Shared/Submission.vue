              ...
              <li v-for="draft in drafts" :key="draft.id" class="py-4">
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <Link
                      :href="
                        route('dashboard', { action: 'submission', draft_id: draft.id })
                      "
            ...
            <div id="submission-dropzone" v-if="currentStep.id == '01'">
              <div v-if="currentDraft">
                <div class="mb-3">
                  ...
                  <jet-input-error :message="draftForm.errors.name" class="mt-2" />
                </div>
                <div class="mb-3">
                  <label
                    for="description"
                  ...
                  <jet-input-error :message="draftForm.errors.description" class="mt-2" />
                </div>
                <div class="mb-3">
                  <label
                    for="description"
                  ...
                  <div>
                    <vue-tags-input
                      ...
                      max-width="100%"
                      :tags="draftForm.tags"
                      @tags-changed="(newTags) => (draftForm.tags = newTags)"
                    />
                  </div>
                  <jet-input-error :message="draftForm.errors.tags" class="mt-2" />
                </div>
                <div>
                  <div>
                    ...
                    <jet-input-error :message="draftForm.errors.studies" class="mt-2" />
                  </div>
                </div>
              </div>
            </div>
