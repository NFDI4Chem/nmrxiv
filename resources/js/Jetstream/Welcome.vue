          ...
          <div class="mt-4">
            <div class="px-6 py-4 bg-white shadow-md rounded-lg">
              ...
              <div class="mt-3 max-w-2xl text-sm text-gray-700">
                nmrXiv is organized around projects. Projects can contain as many studies
              ...
              >
                <div class="flex-grow">
                  <div class="flex justify-between items-baseline">
                    <div
                      class="font-semibold text-md text-gray-600 uppercase tracking-wider"
                    >
                      <div class="flex items-center">
                ...
                <div class="sm:col-span-6">
                  <SwitchGroup as="div" class="flex items-center">
                    <Switch
                      ...
                      :class="[
                        createProjectForm.is_public ? 'bg-green-600' : 'bg-gray-200',
                    ...
                    <span class="flex-grow flex ml-4 flex-col">
                      <span v-if="!createProjectForm.is_public">
                        ...
                        <SwitchDescription
                          ...
                          >Visibility of the project only, not the underlying
                          studies</SwitchDescription
                        >
                      </span>
                      <span v-else>
                        <SwitchLabel
...
export default {
  ...
  methods: {
    createProject() {
      ...
      this.createProjectForm.team_id = this.$page.props.team.id;
