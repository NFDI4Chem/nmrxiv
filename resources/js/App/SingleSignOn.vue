        ...
        <div class="flex mt-3">
            <div v-if="hasNFDIAAIClientID" class="flex-1 w-64 px-1">
                ...
                >
                    ...
                    <img
                        alt="NFDI4Chem Logo"
                        src="https://www.nfdi4chem.de/wp-content/themes/wptheme/assets/img/logo.svg"
                        class="h-5 w-auto"
                        loading="lazy"
                    />
                </a>
...
export default {
    computed: {
        ...
        hasNFDIAAIClientID() {
            return String(this.$page.props.nfdiaai).toLowerCase() == "true";
        },
        hasSingleSingOn() {
            if (
                this.hasTwitterClientID ||
                this.hasGithubClientID ||
                this.hasOrcidClientID ||
                this.hasNFDIAAIClientID
            ) {
                return true;
            } else {
                return false;
