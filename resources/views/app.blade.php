    ...
    <body class="font-sans antialiased h-full">
        ...
        >
            <div class="max-w-7xl mx-auto py-1 px-6 text-center">
              <small><b>DEMO SITE WARNING</b>: Please be aware that this is a demo/test server for nmrXiv and don't upload or save any sensitive data. For real data please visit <a href="https://nmrxiv.org" target="_blank" rel="noopener noreferrer" style=color:blue>nmrxiv.org.</a></small>
            </div>
        </div>
        @endenv -->
